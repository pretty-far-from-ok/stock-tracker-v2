...
class BollingerBandTooltipv1 extends Component {
	constructor(props) {
		super(props);
	...
	renderSVG(moreProps) {
		...
		// const {sourcePath, sourcePath1, windowSize, multiplier, movingAverageType } = options;
		const tooltipLabel = `bollingerband (up, mid, down): `;
		const tooltipValue = `${top}, ${middle0}, ${bottom}`;
		return (
...
BollingerBandTooltipv1.propTypes = {
	...
	options: PropTypes.shape({
		sourcePath1: PropTypes.string.isRequired,
...
BollingerBandTooltipv1.defaultProps = {
...
export default BollingerBandTooltipv1;
